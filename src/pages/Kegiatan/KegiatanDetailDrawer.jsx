...
const KegiatanDetailDrawer = ({ kegiatan, onClose }) => {
  ...
  }, [deleteAllPeserta, showNotification]);
  ...
  return (
    <>
      <Drawer anchor="right" open={open} onClose={onClose} PaperProps={{ sx: { width: { xs: "100%", sm: 680 }, display: "flex", flexDirection: "column" } }}>
        {/* ── Header ───────────────────────────────────── */}
